...
win = pygame.display.set_mode((WIDTH, HEIGHT), pygame.FULLSCREEN)  # Set display to full screen
...
def draw_exit_button():
    ...
    exit_button_rect = pygame.Rect(WIDTH // 2 + 50, HEIGHT // 2 + 50, 100, 50)
    pygame.draw.rect(win, WHITE, exit_button_rect)
    win.blit(exit_button_text, (exit_button_rect.x + (exit_button_rect.width - exit_button_text.get_width()) // 2,
